...
## [4.0.0](https://github.com/ai-dvps/compound-engineering-plugin/compare/compound-engineering-v3.0.0...compound-engineering-v4.0.0) (2026-04-23)


### ⚠ BREAKING CHANGES

* **cli:** rename all skills and agents to consistent ce- prefix ([#503](https://github.com/ai-dvps/compound-engineering-plugin/issues/503))

### Features

* **ce-brainstorm:** product-tier with end-to-end ID traceability ([#629](https://github.com/ai-dvps/compound-engineering-plugin/issues/629)) ([bd77d55](https://github.com/ai-dvps/compound-engineering-plugin/commit/bd77d5550a492974a26b648df4a9dc556acb9dec))
* **ce-code-review:** add Swift/iOS stack-specific reviewer persona ([#638](https://github.com/ai-dvps/compound-engineering-plugin/issues/638)) ([701ae10](https://github.com/ai-dvps/compound-engineering-plugin/commit/701ae10c2dfc60fa50fed11f596c61a0906b3cc4))
* **ce-debug:** environment sanity, assumption audit, more techniques ([#649](https://github.com/ai-dvps/compound-engineering-plugin/issues/649)) ([cce95fb](https://github.com/ai-dvps/compound-engineering-plugin/commit/cce95fb814a69a1414af4bee34933cbc117d2449))
* **ce-demo-reel:** add local save as alternative to catbox upload ([#647](https://github.com/ai-dvps/compound-engineering-plugin/issues/647)) ([fdf5fe4](https://github.com/ai-dvps/compound-engineering-plugin/commit/fdf5fe4af56dab1f40cbf83e2e761997bce8c939))
* **ce-plan:** add U-IDs and origin trace to plan template ([#632](https://github.com/ai-dvps/compound-engineering-plugin/issues/632)) ([44ce9dd](https://github.com/ai-dvps/compound-engineering-plugin/commit/44ce9dd127ccbc300b18051aa2bf7c718112a79c))
* **ce-proof:** broaden triggers and surface markdown viewing ([#618](https://github.com/ai-dvps/compound-engineering-plugin/issues/618)) ([e0f2a4f](https://github.com/ai-dvps/compound-engineering-plugin/commit/e0f2a4f9d748124fecb41114856690f88f8fc2e9))
* **ce-resolve-pr-feedback:** drop bot noise, centralize test runs ([#610](https://github.com/ai-dvps/compound-engineering-plugin/issues/610)) ([b35de99](https://github.com/ai-dvps/compound-engineering-plugin/commit/b35de997884e9d6cf69ef19c983d9e61cf9e4bd8))
* **ce-resolve-pr-feedback:** tighten clustering to cross-round only ([#611](https://github.com/ai-dvps/compound-engineering-plugin/issues/611)) ([2dd0a6e](https://github.com/ai-dvps/compound-engineering-plugin/commit/2dd0a6e6c73abcd74c3709583e03cace63116cdf))
* **ce-review:** add per-finding judgment loop to Interactive mode ([#590](https://github.com/ai-dvps/compound-engineering-plugin/issues/590)) ([27cbaf8](https://github.com/ai-dvps/compound-engineering-plugin/commit/27cbaf8161af8aad3260b58d0d9de03d6180a66c))
* **ce-setup:** check for ast-grep CLI and agent skill ([#653](https://github.com/ai-dvps/compound-engineering-plugin/issues/653)) ([23dc11b](https://github.com/ai-dvps/compound-engineering-plugin/commit/23dc11b95ae46dc6be0308306de5c8f16329fe49))
* **codex:** native plugin install manifests + agents-only converter ([#616](https://github.com/ai-dvps/compound-engineering-plugin/issues/616)) ([3ed4a4f](https://github.com/ai-dvps/compound-engineering-plugin/commit/3ed4a4fa0f6f4d08144ae7598af391b4f070b649))
* **doc-review, learnings-researcher:** tiers, chain grouping, rewrite ([#601](https://github.com/ai-dvps/compound-engineering-plugin/issues/601)) ([c1f68d4](https://github.com/ai-dvps/compound-engineering-plugin/commit/c1f68d4d55ebf6085eaa7c177bf5c2e7a2cfb62c))
* **pi:** first-class support via pi-subagents + pi-ask-user ([#651](https://github.com/ai-dvps/compound-engineering-plugin/issues/651)) ([7ddfbed](https://github.com/ai-dvps/compound-engineering-plugin/commit/7ddfbed33b08e5ad0dc56a3ecc19adb9a10ebb2c))


### Bug Fixes

* **ce-compound:** quote YAML array items starting with reserved indicators ([#613](https://github.com/ai-dvps/compound-engineering-plugin/issues/613)) ([d8436b9](https://github.com/ai-dvps/compound-engineering-plugin/commit/d8436b9a3c5b5370e51ec168a251ccb45f0d826e))
* **ce-debug:** stop hanging handoffs and read full issue thread ([#646](https://github.com/ai-dvps/compound-engineering-plugin/issues/646)) ([86d9a2c](https://github.com/ai-dvps/compound-engineering-plugin/commit/86d9a2c55f49eb49dbbc3d918ce859dbe273d44e))
* **ce-gemini-imagegen:** bump Pillow floor to 10.3.0 to clear 4 CVEs ([#608](https://github.com/ai-dvps/compound-engineering-plugin/issues/608)) ([e152428](https://github.com/ai-dvps/compound-engineering-plugin/commit/e1524287f73ea1ec9598aa63c05a31745ff503c7))
* **ce-learnings-researcher:** drop unreadable schema path reference ([#630](https://github.com/ai-dvps/compound-engineering-plugin/issues/630)) ([05ea109](https://github.com/ai-dvps/compound-engineering-plugin/commit/05ea109bdb68c6f7686d7ab4f52518d9a23a903e))
* **ce-plan:** close exit gates and honor user-named resources ([#597](https://github.com/ai-dvps/compound-engineering-plugin/issues/597)) ([d8e87c1](https://github.com/ai-dvps/compound-engineering-plugin/commit/d8e87c17907b53bead27c223c5f10c7e765d67d8))
* **ce-plan:** inline handoff menu so post-plan options are never skipped ([#615](https://github.com/ai-dvps/compound-engineering-plugin/issues/615)) ([9497a00](https://github.com/ai-dvps/compound-engineering-plugin/commit/9497a00d90bdedf6d1741aa4cf1287fb139ed990))
* **ce-plan:** run ambiguity gate before the non-software catch-all ([#598](https://github.com/ai-dvps/compound-engineering-plugin/issues/598)) ([49249d7](https://github.com/ai-dvps/compound-engineering-plugin/commit/49249d73170b64046a9a6ba38186d483f28047bd))
* **ce-pr-description:** cap description size and add pre-apply preview ([#605](https://github.com/ai-dvps/compound-engineering-plugin/issues/605)) ([409b07f](https://github.com/ai-dvps/compound-engineering-plugin/commit/409b07fbc75148f2c149c1e66744549f5f1dcd58))
* **ce-release-notes:** backtick-wrap `<skill-name>` token in description ([#603](https://github.com/ai-dvps/compound-engineering-plugin/issues/603)) ([2aee4d4](https://github.com/ai-dvps/compound-engineering-plugin/commit/2aee4d42031892e7937640a003d11fad82420944))
* **ce-resolve-pr-feedback:** stop dropping unresolved and actionable feedback ([#617](https://github.com/ai-dvps/compound-engineering-plugin/issues/617)) ([153bea8](https://github.com/ai-dvps/compound-engineering-plugin/commit/153bea8669d63848f57942e842cd58ed664e7435))
* **ce-update:** derive cache dir from CLAUDE_PLUGIN_ROOT parent ([#645](https://github.com/ai-dvps/compound-engineering-plugin/issues/645)) ([6155b9d](https://github.com/ai-dvps/compound-engineering-plugin/commit/6155b9de3c2d60ca424386f2dfcb0dfa7668f2c1))
* **ce-update:** replace cache sweep with claude plugin update ([#656](https://github.com/ai-dvps/compound-engineering-plugin/issues/656)) ([b9ae6b7](https://github.com/ai-dvps/compound-engineering-plugin/commit/b9ae6b758d0d538648cc4dbb09dfb0fa8c0858fb))
* **ce-work:** reject plan re-scoping into human-time phases ([#600](https://github.com/ai-dvps/compound-engineering-plugin/issues/600)) ([b575e49](https://github.com/ai-dvps/compound-engineering-plugin/commit/b575e49c291371b178775a2bd50dbb1cc16210f5))
* **git-commit-push-pr:** apply PR description after delegate hand-off ([#594](https://github.com/ai-dvps/compound-engineering-plugin/issues/594)) ([1afd63c](https://github.com/ai-dvps/compound-engineering-plugin/commit/1afd63cc764173368a30cbd92af704f5b7602e6d))
* **lfg:** use platform-neutral skill references ([#642](https://github.com/ai-dvps/compound-engineering-plugin/issues/642)) ([b104ce4](https://github.com/ai-dvps/compound-engineering-plugin/commit/b104ce46bea4b1b9b0e9cfbdd9203dbc5a0aa510))
* **question-tool:** stop silent skips when tool looks unavailable ([#620](https://github.com/ai-dvps/compound-engineering-plugin/issues/620)) ([d359cc7](https://github.com/ai-dvps/compound-engineering-plugin/commit/d359cc7e2f4dd5e920e7daa6dbd1eddc8f53bc19))
* **skills:** cap skill descriptions at harness limit ([#643](https://github.com/ai-dvps/compound-engineering-plugin/issues/643)) ([13f95ba](https://github.com/ai-dvps/compound-engineering-plugin/commit/13f95ba6392f86aa8dd9b4430b84f0b7523c6c89))


### Code Refactoring

* **cli:** rename all skills and agents to consistent ce- prefix ([#503](https://github.com/ai-dvps/compound-engineering-plugin/issues/503)) ([5c0ec91](https://github.com/ai-dvps/compound-engineering-plugin/commit/5c0ec9137a7350534e32db91e8bad66f02693716))
